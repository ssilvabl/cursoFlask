# Importar funciones para interactuar con el sistema
import os
# Importar Flask
...
# Importar dotenv para trabajar con variables de entorno
...
def crear_app():
    ...
    cliente = MongoClient(os.getenv("MONGODB_URI")) # -> Obtener variable de entorno
    # Acceder a la DB
    app.db = cliente.blog
